...
# #3Негативная регистрация с неверным паролем
# @pytest.mark.parametrize('x', ["9959967398", "regpostt@mail.ru"], ids=["valid_phone", "valid_mail"])
...
# #4Негативная регистрация с неверным логином
...
# #10Позитивное тестирование поля имя(минимум 2 символа состоящих из букв кириллицы или знака тире (-))
# @pytest.mark.parametrize('x', ["фф", "ааа", "фф-", "ааааааааааааааааааааааааааааа"])
# def test_positive_registration(selenium, x):
#     page = AuthPage(selenium)
#     page.reg_click()
...
# def test_negative_registration(selenium):
#     page = AuthPage(selenium)
#     page.reg_click()
#     name = ["1", "", "@@а", "-а", "а", "аааааааааааааааааааааааааааааа", "f"]
#     for i in name:
